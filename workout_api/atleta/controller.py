...
from workout_api.atleta.schemas import AtletaIn, AtletaOut, AtletaUpdate, AtletaSummaryOut
...
async def query(
    ...
    return await sqlalchemy_paginate(db_session, query_statement)
